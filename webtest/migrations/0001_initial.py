# Generated by Django 2.0.13 on 2020-10-03 08:06
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('webtester', models.CharField(max_length=200, verbose_name='测试负责人')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('webevelement', models.CharField(max_length=800, verbose_name='操作方法')),
                ('webtestdata', models.CharField(max_length=200, verbose_name='测试数据')),
                ('webtestresult', models.BooleanField(verbose_name='测试结果')),
                ('create_time', models.DateTimeField(auto_now=True, verbose_name='创建时间')),
