# Generated by Django 3.0.9 on 2020-09-29 07:46
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('product', '0002_auto_20200404_2012'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('appevelement', models.CharField(max_length=800, verbose_name='空间元素')),
                ...
                ('appassertdata', models.CharField(max_length=200, verbose_name='验证结果')),
                ('apptestresult', models.BooleanField(verbose_name='测试结果')),
                ('create_tiem', models.DateTimeField(auto_now=True, verbose_name='创建时间')),
