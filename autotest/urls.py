...
urlpatterns = [
    ...
    path('apitest_manage/update/', views.apitest_update),
    path('apitest_manage/update/submit/', views.apitest_update_submit),
    path('apitest_manage/delete/', views.apitest_delete),
    path('apitest_manage/delete/submit/', views.apitest_delete_submit),
